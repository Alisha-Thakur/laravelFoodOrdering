			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-lg-6">
						<ul>
							<li>
								<a href="ali1.php" name="nav">Home</a>
							</li>
							<li>
							...
							<li>
								<a href="cart" class="nav-item active nav-link">
								<h5 class="px-3 cart">
						...
						?>
							...
							<li>
								<a href="login.php"><i class="fa fa-user-circle-o" aria-hidden="true" style="color: white; font-size: 18px;"> &nbsp;<?php echo $_SESSION['username']; ?></i></a>
