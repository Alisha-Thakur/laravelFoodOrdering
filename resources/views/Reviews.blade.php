...
<html>
 ...
 <body>
        <nav>
                ...
                <ul class="nav-links">
                    <li>
                        <a href="index1.php" class="active" name="nav">Home</a>
                    </li>
                    <li>
        ...
        <div id="image1" class="img" data-img="images/5f7.jpg"><span class="multiline"><span class="max">Scroll down to see what our customers are saying</span>Reviews from some of our satisfied customers</span></div>
        <div id="image2" class="img" data-img="images/bd0.jpg"><span class="multiline"><span class="max">Anurag from Chandigarh says:</span>The donner wraps are just heavenly</span></div>
        <div id="image3" class="img" data-img="images/ipe3.jpg"><span class="multiline"><span class="max">Mansi from Jalandhar says:</span>The crispiest chicken pakoras I ever had</span></div>
        <div id="image4" class="img" data-img="images/oto.jpg"><span class="multiline"><span class="max">Raj from Amritsar says:</span>Stopped for some snacks, had the crispy samosas. Never had better samosas in my life</span></div>
        <div id="image5" class="img" data-img="images/age1.jpg"><span class="multiline"><span class="max">Rohini from Mumbai says:</span>You know the place is good when even the mushroom bhaji is good</span></div>
        <div id="review" class="button1 md-col-8 py-5 img" data-img="images/abstract1080-01.svg">
        
        <a href="reviews2" class="multiline"><button class="btn-warning btn-block col-md-15">READ ALL REVIEWS</button></a>
    </div>
